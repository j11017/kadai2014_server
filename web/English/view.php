...
function readData($my, $id){
	...
	print("<tr>");
	print("<th class='head'>Game ID</th><th class='head'>Turn</th><th class='head'>Player</th><th class='head'>Position</th><th class='head'>Evaluation</th><th class='head'>Time</th>");
	print("</tr>");
...
print("<script type='text/javascript' src='https://www.google.com/jsapi'></script>
    <script type='text/javascript'>
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Transition of evaluation'
        };
  ...
  function drawEvaluation(currentTurn) {
    ...
    if(canvas.getContext) {
      ...
      context.fillStyle = 'rgb(0, 0, 0)';
      context.fillText('Evaluations', 110, 110);
...
?>
	...
	<form name="reversiBoardForm" id="reversiBoardForm" onSubmit="return onButtonClick()">
		...
		<input type="button" value="View" onclick="onButtonClick();" />
